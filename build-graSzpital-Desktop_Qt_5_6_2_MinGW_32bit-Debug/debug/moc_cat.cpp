...
QT_MOC_LITERAL(1, 4, 12), // "move_forward"
...
const QMetaObject Cat::staticMetaObject = {
    { &Animal::staticMetaObject, qt_meta_stringdata_Cat.data,
      qt_meta_data_Cat,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Cat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cat.stringdata0))
        return static_cast<void*>(const_cast< Cat*>(this));
